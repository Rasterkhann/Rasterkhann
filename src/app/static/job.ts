...
function NoBonus(): number { return 0; }
function PrimaryBonus(retirees: bigint): number { return Number(retirees) * 0.03; }
function SecondaryBonus(retirees: bigint): number { return Number(retirees) * 0.01; }
...
export const JobEffects: Record<HeroJob, HeroJobStatic> = {
  [HeroJob.Adventurer]: {
    ...
    statGrowth: {
      [HeroStat.LVL]:  () => 1,
      [HeroStat.EXP]:  (level) => level * random(200, 300),
      [HeroStat.HP]:   () => 12,
      [HeroStat.SP]:   () => 4,
      [HeroStat.ATK]:  () => 2,
      [HeroStat.DEF]:  () => 2,
    ...
    retireGrowth: {
      [HeroStat.LVL]:  NoBonus,
      [HeroStat.EXP]:  NoBonus,
      [HeroStat.HP]:   NoBonus,
      [HeroStat.SP]:   NoBonus,
      [HeroStat.ATK]:  PrimaryBonus,
      [HeroStat.DEF]:  SecondaryBonus,
      [HeroStat.STA]:  NoBonus,
      [HeroStat.GOLD]: NoBonus
    },
    triggers: {},
    combatTriggers: {},
    actions: (hero: Hero) => {
  ...
  [HeroJob.Cleric]: {
    ...
    statGrowth: {
      [HeroStat.LVL]:  () => 1,
      [HeroStat.EXP]:  (level) => level * random(300, 350),
      [HeroStat.HP]:   () => 10,
      [HeroStat.SP]:   () => 3,
      [HeroStat.ATK]:  () => 2,
      [HeroStat.DEF]:  () => 3,
    ...
    retireGrowth: {
      ...
      [HeroStat.EXP]:  NoBonus,
      [HeroStat.HP]:   NoBonus,
      [HeroStat.SP]:   PrimaryBonus,
      [HeroStat.ATK]:  SecondaryBonus,
      [HeroStat.DEF]:  NoBonus,
      [HeroStat.STA]:  NoBonus,
      [HeroStat.GOLD]: NoBonus
    },
    triggers: {},
  ...
  [HeroJob.Mage]: {
    ...
    statGrowth: {
      [HeroStat.LVL]:  () => 1,
      [HeroStat.EXP]:  (level) => level * random(350, 400),
      [HeroStat.HP]:   () => 5,
      [HeroStat.SP]:   () => 3,
      [HeroStat.ATK]:  () => 3,
      [HeroStat.DEF]:  () => 2,
    ...
    retireGrowth: {
      [HeroStat.LVL]:  NoBonus,
      [HeroStat.EXP]:  NoBonus,
      [HeroStat.HP]:   PrimaryBonus,
      [HeroStat.SP]:   NoBonus,
      [HeroStat.ATK]:  NoBonus,
      [HeroStat.DEF]:  NoBonus,
      [HeroStat.STA]:  SecondaryBonus,
      [HeroStat.GOLD]: NoBonus
    },
    triggers: {},
    combatTriggers: {
  ...
  [HeroJob.Thief]: {
    ...
    statGrowth: {
      [HeroStat.LVL]:  () => 1,
      [HeroStat.EXP]:  (level) => level * random(150, 200),
      [HeroStat.HP]:   () => 7,
      [HeroStat.SP]:   () => 5,
      [HeroStat.ATK]:  () => 3,
      [HeroStat.DEF]:  () => 2,
  ...
  [HeroJob.Warrior]: {
    ...
    statGrowth: {
      [HeroStat.LVL]:  () => 1,
      [HeroStat.EXP]:  (level) => level * random(300, 400),
      [HeroStat.HP]:   () => 15,
      [HeroStat.SP]:   () => 1,
      [HeroStat.ATK]:  () => 4,
      [HeroStat.DEF]:  () => 2,
